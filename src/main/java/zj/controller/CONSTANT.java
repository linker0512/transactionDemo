...
public class CONSTANT {
    public static final String TEMPLATES_ACCOUNT_GET_ACCOUNT= "account/getAccount";
    public static final String TEMPLATES_ACCOUNT_CREATE_ACCOUNT="account/account1" ;
